...
<pattern>
    ...
    <rule context="pxs-taxdata:TaxData/pxs-taxdata:ReportedTransaction/pxs-taxdata:ReportedDocument/pxs-taxdata:DocumentTypeCode">
      <assert id="PEPPOL-EN16931-P0100" test="           $profile != '01' or (some $code in tokenize('71 80 82 84 102 218 219 326 331 380 382 383 384 386 388 393 395 553 575 623 780 817 870 875 876 877 381 396 81 83 532', '\s')             satisfies normalize-space(text()) = $code)" flag="fatal">Invoice/Credit note type code MUST be set according to the profile.</assert>
